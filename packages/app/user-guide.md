...
**Rod aim** says which way a tilted rod leans relative to the wind. 0° — the default, and how every flight flew before this field existed — leans it straight into the wind; 180° leans it downwind; ±90° across it, positive to your right as you face into the wind. Leaning into the wind and letting the rocket weathercock usually gives the lowest apogee and the least drift; leaning downwind lets the wind stand it back up, so it climbs higher and drifts further. Measured on a small C6 test rocket on a 5° rod in a 4 m/s wind: 320 m of apogee and 303 m of drift aimed into the wind, 325 m and about 355 m across it, 331 m and 402 m downwind. With a vertical rod the aim does nothing, and a negative Rod angle is already the same flight as adding 180° here. The aim turns the rod, not the wind — the app's wind always blows from the east — so a rod aimed across the wind lands the rocket off to the side it leans.
...
**What it can and cannot tell you.** The wind is the forecast's 10 m (33 ft) wind at the hour you pick — an instantaneous value at that time, not an average over the hour — and at one level: the app's wind does not change with height. The gust is the strongest in the hour before, shown for reference (see *Wind gusts from a forecast* below). The wind direction is shown too, but not applied: the app's wind has no compass direction, and a bearing cannot say how your rail leans against it — set **Rod aim** yourself. Open-Meteo forecasts 16 days ahead at most; for past dates it keeps its forecasts for 92 days, and before that the app uses the ERA5 reanalysis — the weather as it was, back to 1940, not a forecast. A town search finds the **town centre**, not your field, and the review says so; for a field out of town, paste the field's coordinates. Postal-code search works mainly in the US and a few other countries — elsewhere, search the town name.
