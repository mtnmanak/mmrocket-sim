...
One field is worth a second look now that thrust depends on it too. **Pressure** means the pressure *at the pad* — what a barometer reads standing there — not the sea-level-corrected altimeter setting an airport broadcasts. Two ways to get it wrong, and both matter more at a high site:

- **Leave BOTH temperature and pressure blank** and the app computes the pad's pressure from your site altitude, which is the right answer. But **leave only the pressure blank while you type a temperature** and it does not: the app then flies **101,325 Pa — sea-level pressure — at your pad**, whatever altitude you set. Measured at a 3,900 ft (1,190 m) site: both fields blank gives 87,854 Pa at the pad; a temperature typed with pressure blank gives 101,356 Pa. At 8,800 ft the pair is 73,018 Pa against 101,354 Pa — the same sea-level number. **So whenever you type a temperature, type the pad's station pressure too.**
