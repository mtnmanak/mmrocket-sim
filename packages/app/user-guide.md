...
A forecast does not give **Wind gusts σ** directly — it gives a gust. Once a forecast's wind is applied, a row under the two wind fields offers an estimate: **σ ≈ (gust − average) ÷ 3.0**, rounded to 0.01 m/s. Nothing changes until you press **Estimate from forecast gust**: the weather dialog's Apply never sets σ, and the Fly screen never offers it. Once applied, the row says σ is an estimate and shows the arithmetic.
