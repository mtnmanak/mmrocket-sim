...
**What leaves your browser.** The place you type, or your coordinates, go to Open-Meteo; nothing about your rocket does. Open-Meteo keeps request logs, which include your IP address and the coordinates, for 90 days, and says it shares them with no one. A position from your device is rounded to about 1 km before it is sent or saved — worth knowing, because latitude and longitude travel inside any `.ork` or share link made from the design.
