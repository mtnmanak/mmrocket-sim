...
- **Cesaroni publish nothing anyone has found**, and four Loki motors are short (their published exit table stops at 76 mm, and the 54/4000 case has no commercial nozzle listed). Those motors leave the field alone and say nothing. Take the number from the motor's data sheet or measure the hardware; all the app can check is that it is not wider than the casings it comes out of.
