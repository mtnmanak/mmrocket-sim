...
**What it can and cannot tell you.** The wind is the forecast's average at 10 m (33 ft) for that hour, at one level — the app's wind does not change with height. The gust is the strongest in the hour before, shown for reference (see *Wind gusts from a forecast* below). The wind direction is shown too, but not applied: the app's wind has no compass direction. Open-Meteo forecasts 16 days ahead at most; for past dates it keeps its forecasts for 92 days, and before that the app uses the ERA5 reanalysis — the weather as it was, back to 1940, not a forecast. A town search finds the **town centre**, not your field, and the review says so; for a field out of town, paste the field's coordinates. Postal-code search works mainly in the US and a few other countries — elsewhere, search the town name.
