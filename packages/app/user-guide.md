...
the delay its newest flight of the design as it stands flew — its rounded optimum — and that flight
is the one written beside it; with no such flight it is saved at its provisional delay, and the save
note says so. Either way the file reopens with that delay fixed, not on auto. Only the
