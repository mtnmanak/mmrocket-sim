...
| Tube fins | Fin set | count (1–8, and capped to how many tubes fit around the body once you set an outer radius), length, outer radius (blank = auto-sized so the tubes just touch), wall thickness |
