...
// `deadline` — the caller's cancel merged with this download's own timeout,
// told apart afterwards — lives in net.ts now (weather build, 2026-09-22),
// shared with the weather requests; moved there unchanged.
